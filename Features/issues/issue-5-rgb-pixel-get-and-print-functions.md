---
title: "Feature #5: RGB pixel, get and print functions"
description: "To facilitate access to pixels of the data array, we propose to define a structure and a function to access to specific pixel at position x,y."
Milestone: 1
Issue: 5
---
