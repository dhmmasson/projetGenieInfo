...
You can implement these features in any order and in parallel. You can still together for the first feature then split the remaining 3 features between you. Read the [collaboration strategies](Resources/Collaboration.qmd) to find how to properly split the work and collaborate effectively.
...
## Issues
- [#8](../issues/feature-8-max-pixel.md) Max pixel 
- [#9](../issues/feature-9-min-pixel.md) Min pixel 
- [#10](../issues/feature-10-max-component.md) Max component 
- [#11](../issues/feature-11-min-component.md) Min component 
- [#12](../issues/feature-12-full-report-in-a-txt-file.md) Full report in a txt file 
