...
- [#4](../issues/feature-4-color-of-the-first-pixel.md) Color of the first pixel (OPEN)
- [#5](../issues/feature-5-color-of-the-10th-pixel.md) Color of the 10th pixel (OPEN)
- [#6](../issues/feature-6-color-of-the-first-pixel-on-the-second-line.md) Color of the first pixel on the second line (OPEN)
- [#7](../issues/feature-7-rgb-pixel-get-and-print-functions.md) RGB pixel, get and print functions (OPEN)
